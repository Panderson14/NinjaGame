...
class SKSimpleButton: SKSpriteNode {
    ...
    */
    ...
    override func touchesBegan(touches: NSSet, withEvent event: UIEvent) {
        ...
        let touchLocation = touch.location(parent!)
    ...
    override func touchesEnded(touches: NSSet, withEvent event: UIEvent) {
        ...
        if (targetTouchUpInside != nil && targetTouchUpInside!.responds(actionTouchUpInside!)) {
            let touch: AnyObject! = touches.anyObject() as AnyObject!
            let touchLocation = touch.location(parent!)
        ...
        if (targetTouchUp != nil && targetTouchUp!.responds(actionTouchUp!)) {
